const catBreeds = [{
    ...
    console.log("Name cat breed 3:", catBreeds.at(-1).name)
    console.log("Energy level cat breed1:", catBreeds[0].energy_level)
    console.log("First temperament cat breed 2:", catBreeds[1].temperament[0])
    console.log("Last temperament of cat breed 3: ", catBreeds[2].temperament.at(-1))
